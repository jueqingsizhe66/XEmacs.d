...
** Rich(clojure master)
 https://gist.github.com/richhickey
** Emacs programming guide
...
** novel
抗日之战将传奇
 https://www.qu.la/book/35326/2057707.html
 
最强医圣
https://www.qu.la/book/20060/10629749.html
    最新章节
    http://www.biqukan.net/book/40730/
** Emacs developer
 https://savannah.gnu.org/projects/Emacs

https://savannah.gnu.org/git/?group=emacs

Soldiers , go on. 士兵 继续
...
`make tags` /TAGS----->产生etags等等，进入emacs源码文件夹。
`M-x visit-tag-table` ---->进入src文件夹，然后运行该命令即可

LSP: lanaguage server protocol make  you programming faster!

Intergrate it into your life.
...
** dynamicYawEnergies
 https://github.com/wmunters/paper_yawinduction_energies

https://github.com/wmunters/paper_torque18

https://github.com/wmunters/phd_thesis
** using chicken scheme to make games
 http://alex-charlton.com/posts/Prototype_to_polish_Making_games_in_CHICKEN_Scheme_with_Hypergiant/?tdsourcetag=s_pctim_aiomsg
** pyTorch 深度学习框架
 https://pytorch.org/tutorials/
** What is grammer?
 https://academic.udayton.edu/SaverioPerugini/courses/cps343/lecture_notes/grammars.html
** 徐建中忆吴仲华
 徐建中忆吴仲华：绝江者托于船 致远者托于骥  http://news.sciencenet.cn/htmlnews/2018/12/421235.shtm
[[file:%E5%BE%90%E5%BB%BA%E4%B8%AD%E5%BF%86%E5%90%B4%E4%BB%B2%E5%8D%8E.org][绝江者托于船]]
** perl高质量帮助文档
 https://perldoc.perl.org/perl.html?tdsourcetag=s_pctim_aiomsg
** 王小波文集
 https://www.kanunu8.com/files/writer/156.html
** The little Prover
 https://the-little-prover.github.io/
 
[[file:j-bob-lang.scm][j-bob-lang.scm]]

[[file:j-bob.scm][j-bob.scm]]

[[file:little-prover.scm][little-prover.scm]]
** Actframework
...
** hutool值得拥有
 https://hutool.cn/
** It's time for the cleanest energy
 https://www.blancair.com/
 
https://mp.weixin.qq.com/s?__biz=MjM5Mzk4Mzg3NA==&mid=2651975050&idx=2&sn=e8789228e81e99b5ac48eb95c5913c77&chksm=bd6bf1678a1c7871f93494d2c621a8fd0406483e78b239fb716fdfb83192bcdb6635879463b5&mpshare=1&scene=1&srcid=0110HHGkY83iNLShXINOeq8J#rd


LET’S START THE NEXT GENERATION OF WIND ENERGY(下一代风能)
Presenting the first wind turbine that generates clean energy and cleans the air(清洁空气) at the same time. For this purpose, we are developing a product, which reduces the content of Carbon Dioxide in the atmosphere while operating economically by improving the efficiency of the wind turbine.


*** THE NEXT GENERATION OF WIND ENERGY.

Our vision is a new generation of wind turbines! In the past, mankind only produced energy from fossil fuels creating damage to human health and the environment. Today, we can use renewable energy to produce clean, climate friendly energy but we have to go even further. BLANCAIR is the first energy generation, a technology that simultaneously produces clean energy and strengthens the environment(加强环境保护).
...
[[file:renewableEnergy/Climate.png][气候变化]]

*** THE BENEFITS.

We can generate electricity, gather CO2(同时捕捉) at the same time and use the recovered raw material to produce synthetic gasses or fuels directly at the turbine or in the wind farm. There is no downtime of the wind farm when the grid is overloaded, since the wind energy by the combined use of the CO2 can be stored as e-Fuels with the well-known power-to-liquids technology(能量液体技术).

**** In addition:

The system works in a passive mode – no energy is consumed for collecting CO2(捕捉co2能量来自哪里?).
...
[[file:renewableEnergy/cloud_wind_turbine.jpg][turbine in the cloud]]

WITH 20 YEARS EXPERTISE IN AVIATION AND WIND ENERGY TO INNOVATIVE PRODUCTS.

The Engineering Office SPITZNER ENGINEERS (founder and owner Joerg Spitzner), located in Hamburg Finkenwerder, has been active in the aviation and wind energy industry for two decades. The services range from structural solutions, through production technologies and aerodynamic optimizations to complete product ideas such as the new wind energy technology BLANCAIR. 

SPITZNER ENGINEERS owns or has significant involvement in more than 60 publications and patents(专利) and was honored with the 2013 German Renewables Award. 

[[file:renewableEnergy/180710_BLANCAIR_02.mp4][下一代风力机]]
** ASME V20-2009(R2016)
 ASME V&V 20-2009 (R2016) 
Standard for Verification and Validation in Computational Fluid Dynamics and Heat Transfer

https://www.techstreet.com/standards/asme-v-v-20-2009-r2016?product_id=1669326
** Batsov(projectile and cider author)

https://emacsredux.com/blog/2019/01/10/the-emacs-year-in-review/
 
Batsov个人主页 https://metaredux.com/projects/
super save也是他写的
