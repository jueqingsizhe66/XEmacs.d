...
** NPM(Natural Planning Model) [#B]                                 :@NCEPU:
:LOGBOOK:
CLOCK: [2018-11-30 周五 10:37]--[2018-11-30 周五 11:06] =>  0:29
:END:
                         Added: [2018-11-30 周五 10:36]
                         
                         
 http://members.optusnet.com.au/~charles57/GTD/Natural_Project_Planning.html
                         
Project=purposes+images(visual outcome)+commits(续延 continuation)+Done
What is your image for your purpose?
...
Thinking in more effective ways about projects and situations can make things happen sooner,
 better and more successfully.

When you think about doing something that requires several steps,
 your mind goes through five steps:

****  Defining purpose and principles. 

Purpose is your intention to do something, for example, "Let's go out to dinner".
 Your principles create the boundaries of your plan, for example,
 "I want to eat at a quality restaurant with good service and located in a convenient part of town".
**** Outcome visioning.
 In the previous step, you identified why you want to do something.
 In this step you create an image of what you want to achieve or get out of completing the activity.
 For example, "I want to host an unforgettable dining experience for my overseas visitors".
 
Most projects don't need much more than a clear statement of the outcome 
and the next action you need to take. This is all you may need to do to 
get the project off your mind so you stop thinking and worrying about it. 
(大胆去做)
**** Brainstorming.
 This is when you start to think about many aspects of the project.
 - why(first place when you do your project)---what will the project look like when it is done?----你得问问你自己
   一定得学会ask yourself to image your outcome of project
 How would this completed project feel, sound, smell, taste and look like.
 Use all your senses. Draw a picture of the completed project or some visual representation of completion
 - focus(When you focus , world is looking at you ) Focus helps us get started with an activity
   Please focus on your image(并不是每个人都有它的image的)
   Image yourself, imagine your future, focus let you achieve your thinking.
 Who, what, when, where, why and how? 
 How much time and money are available?(知道目标、预期的成果才会想着去做,想着去投入精力和钱财)
 Who needs to be involved?
 What needs to be done?
 This thinking process can be quite chaotic and it may not be possible to complete this thinking in one session.
 What you are trying to do in this step is identifying 
what needs to happen to take you from your present situation 
to achieving the desired purpose and outcome.
**** Organizing.
 Once you have generated a sufficient number of ideas and details,
 you need to organise them into some sort of structure or sequence.
 One way is to organise the project into a hierarchical structure called a "Work Breakdown structure" (WBS).
 You identify the resources(肯定会去思考), costs, people and skills needed,
 - resources(资源)
 - costs(highest cost,成本控制很重要)
 - people(人员)
 - skills(技能)
 as well as determining a rough sequence of events and dependencies.
**** Identifying Next Actions(续延,cps, continuation).
 Now that you have completed the previous four steps, decide if you are committed to go ahead with the project.
 What is the next action that you need to take to move closer to completion?

 **** what is next action and project?
 A next action is something you can do that would complete a task to achieve a desired outcome,
 for example "Make photocopy of letter". A project is an outcome that requires more than one next action to complete, for example "Organize a conference". 


 后来，我看到有两个小伙伴在操场上踢球，一个小伙伴教另外一个小伙伴如何踢球，慢慢的运球、推球、感受球的存在，
我感受到是在认真的交流，换位的传达.

一门编程语言、一个程序模块你得去感受那是人类的智者用他们的精力谱写的作品，
留给世人。【切勿想当然】
** perl 训练 [#B]                                                     :perl:
:LOGBOOK:
CLOCK: [2018-12-02 周日 00:51]--[2018-12-02 周日 02:52] =>  2:01
- Clocked out on T:[2018-12-02 周日 02:52] \\
  有人看不见前门，有人找不见前门，就去走后门，一下子就送到了骗子的怀抱
  有人看不见前门，有人找不见前门，结果走了后门，最后一头栽进骗子怀里
CLOCK: [2018-11-30 周五 23:38]--[2018-12-01 周六 19:13] => 19:35
- Clocked out on T:[2018-12-01 周六 19:13]
CLOCK: [2018-11-30 周五 19:53]--[2018-11-30 周五 23:07] =>  3:14
- Clocked out on T:[2018-11-30 周五 23:07] \\
  了解了perl的 tutorial
:END:
                         Added: [2018-11-30 周五 19:53]
                         
                         
Perl Best practices!

重要模块: Perl::TIdy ->  Perl code beautifier
         ...
         Perl::Critic-> static Code Analysis for perl
                         ...
                         Configurable and extensible for local policies
                         and styles(includes over 120 policies) what is policy?
         ...
         Test::*
          ...
          Devel::Cover
                     ...
                     Tells you what code has been executed, statements,
                     condition, subroutine, pod, branch

                     
君子让人，仁者长寿


人生天地间，高不赢七尺，寿不过百年，本无高低贵贱啊，

水往低处流，人往高处走。不能自个儿瞧不起自个儿。
...
巴金老人家说得对:"有人看不见前门，有人找不见前门 ，就去走后门，一下子就找到骗子了"
（也类似希区柯克说的"桌子底下的炸弹",大家并不知道这颗炸弹什么时候会引爆,但是时间到了
他就会被引爆(适当的时刻引爆他，也可以是包袱，在适当的时候打开这个包袱)。
--（一个假宝贝大家抢，疯狂的石头,被调包的翡翠 , 这个世界什是真的什么是假的?么)  

有些人只是一面镜子，能够折射出世间的人生百态,能够看到众人的真实内心世界
鲁迅先生说的:"勇者愤怒，抽拳向着最强者，弱者愤怒，抽拳向着最弱者"

疑人不用 用人不疑!

社会的意识形态是几千年积淀起来的
时时刻刻站在别人的角度去思考。不要空有其表,制度存在虽然得无条件执行，但是得有人情味!
** 戒浮 [#B]                                                        :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-04 周二 19:49]--[2018-12-04 周二 22:15] =>  2:26
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-04 周二 19:49]
                    :END:
                         
                    
戒满,满则天求，戒骄，骄则无知，戒惰，惰则无进，戒浮，浮则无深

人忙则无事，人闲则生事

子曰：“君子不重则不威；学则不固。主忠信。无友不如己者。过则勿惮改。”

译文——孔子说：“与人交往时，如果举止不庄重，就没有威信；
学到的知识也记不牢固。为人处世要以忠信为主。不要同不如
自己的人交朋友。犯了过错，就不要害怕改正。”
...
古人云:“心浮则气必躁,气躁则神难凝。”这说的是做人不踏实,做事不...
能够负重,方能担当重任。力戒浮躁,还要大力倡导实干精神,大兴求真务实之风

其生若浮,其死若休。”出自《庄子·刻意》。浮:轻。休:休息。
整句话的意思是:把生看得很轻,把死看得像休息一样。
** 不是耕耘就有收获 [#B]                                            :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-05 周三 13:16]--[2018-12-05 周三 13:55] =>  0:39
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-05 周三 13:16]
                    :END:
...
** 重要的事情 [#B]                                                  :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-06 周四 18:59]--[2018-12-06 周四 19:01] =>  0:02
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-06 周四 18:59]
                    :END:
                         
                    
重要的观点，你要说的主要结论通常是放在前面，让读者知道你的意图。
比如:

```
在来流一定的情况下，机舱风速主要受到风电机组近尾流的影响。
风电机组尾流流场可以分为近尾流区域和远尾流区域。近尾流区
域主要是.....
...
** 表面粗糙度 [#B]                                                    :学术:
:LOGBOOK:
CLOCK: [2018-12-07 周五 21:44]--[2018-12-09 周日 07:39] => 33:55
- Clocked out on T:[2018-12-09 周日 07:39]
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-07 周五 21:43]
                    :END:
                         
At a given wind speed, increasing surface roughness elevates the 
amount of shear at the surface. Stull [1] provides a useful table
...
** 规划和格局 [#B]                                                    :学术:
:LOGBOOK:
CLOCK: [2018-12-09 周日 10:03]--[2018-12-09 周日 11:33] =>  1:30
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-09 周日 10:01]
                    :END:
                         

                    
做事的厚道体现一个人的格局和境界。处处替你的伙伴考虑，而不是
过于自私
...
org-board---organization board


Valuable-final-product(VFP)
           high-quality-product  HQP(The quality of organization)
               the quality of 友谊

Put all the logic into sequence, spiral marching onto your target, (Accounting
marketplace, product development)

org-board用四个成语来解释，"各司其职, division management"
和goal management的类似

人-事划分，人(director,management, solider, HR, saler)
          事（many goals)
          人 assign thing on another persons(responsiblity任务指派), 并带上工作进度,是否到期!让老板一览无余
          一个board，一个项目简介

org-board的核心是Division(部分).（valuable final product)

公司部门管理的意思。

scientology 科学教
https://www.youtube.com/watch?v=lrbp7L6r_WI
** problem decomposition [#B]                                       :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-09 周日 17:20]--[2018-12-09 周日 17:21] =>  0:01
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-09 周日 17:20]
                    :END:
                         
                    
Problem decomposition is a key skill: breaking a challenge down into small,
 motivating steps, identifying the things you need to figure out first so
 that you can build on top of them. It’s hard when you’re new, and easier w
hen you’ve solved lots of similar problems. I want to get super-good at this
, which probably means doing this with more breadth and depth so that we 
have more building blocks to play with.
http://sachachua.com/blog/category/idea/

Start wit nothing--> do something(at school)---->do something at mid school
--->branches(go high school, go do selling, go home) -----> go to school
---->branches(go to university, go to work...) ---> continue reading
----> go to work ----end of your life.

Sometimes you work with others, sometime you work with yourself.

All get things done is just focus on your heart!Focus your soul.如流水一般，
只是希望能够抓住时间的缝隙，时间的棉絮，轻飘飘, 螺旋式的推进，在不断的
推进中逐级分层推进。
...
叶静开(<2018-12-09 17:46>)。
https://www.slideshare.net/sachac/how-to-draw-a-presentation/3

佛法说,就是由戒而生定,由定而得到慧,
戒、定、慧三学是佛法的基本内容.安,是指内心的平静,不生杂乱的妄想；
由安而得到心态的稳定,所以说是安而后定；由于心智的平稳,所以思考能力集中专一,
自然就是智慧思维的起源；由于得到细致认真的反思,自然就是觉悟的道路.
真能够完成觉悟了,也就没有什么疑惑和烦恼了.
从儒家来说也一样,《大学》中说:"
...
止--静---停
止而定，定而静，静而安，安而思，思而得        
止而定，定而静(不一定静,得定而心静)，静而安(过渡到安宁)，安而定，定而慧，
慧而悟，悟而得。       

1. Lack of connection
2. Lack of interaction
https://www.slideshare.net/sachac/remote-presentations-that-rock-2011


井淘三遍出好水，人从三师武艺高
** Y combinator [#B]                                             :emacslisp:
:LOGBOOK:
CLOCK: [2018-12-10 周一 22:44]--[2018-12-10 周一 23:08] =>  0:24
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-10 周一 22:44]
                    :END:
...
#+END_SRC
      ...
      1. f(x) = (lambda (x) (f x) arg)
       
       
      2. ((fact fact) x) ---> fact is a procedure, he need a procedure as its
         parameter, and x should become smaller or bigger with time going,
         in order to end. Yeah , it means F* below should satisfy two conditions
         a. an end condition (stop condition), such as (null? lst) 
            (null? (cdr lst))  (zero? x) (one? x) (atom? (car lst)) 
            (lst? lst) (lst? (cdr lst))  (lat? (car lst)) 
         b. the recursive part ,make x become bigger or smaller depend on the 
            end condition constraints
            when terminate line is 1, use *
            When terminate line is 0, use +
            When terminate line is (), use cons
            When asking lat question is zero? , use (sub x) in the natural recursion
            When asking lat question is null? , use (cdr lst) in the natural recursion
            When asking list question is atom?, use (car lst) (cdr lst) in the natural recursion

            lat for two questions! lsit for three questions， all have the 
            correct answer "else", else means default correct answer.
...
Y combinator 本身就是一种藏的能力，藏而无名，身本无名，只在螺旋推进
借助于lambda,if, great than etc primitive operators without define,
we can also create the world of no-name.

无名则明，明则静，静则定，定则慧，慧则悟，悟则开，开则终
** 旅行中拍照是个坏习惯 [#B]                                        :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-13 周四 22:07]--[2018-12-13 周四 22:07] =>  0:00
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-13 周四 22:06]
                    :END:
                         
                    
http://www.yinwang.org/blog-cn/2015/03/20/photograph
为什么拍照是个坏习惯
...
** 听彭教授讲课 [#B]                                                :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-20 周四 22:43]--[2018-12-20 周四 23:23] =>  0:40
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-20 周四 22:43]
                    :END:
                         
                    
第一讲: 基础理论
第二讲: 方法介绍(URANS , LES, hybrid LES-RANS)
第三讲: 工程运用(飞机起落架、瑞典森林环境下的下游风力机)

流固耦合是个非定常的计算过程

数值耗散如果比较大，计算出来的结果可能就是一个定常解(可以换一种方法，比如Hybrid RANS LES，进行求解)


分离流是指高剪切地方

SA-DDES是被遗弃的求解器，因为上游URANS结果无法较好的发展下游的非定常分离流动现象
于是发展出来IDDES求解器


RANS-LES进行模拟之前，最好通过PSE(partial 抛物线稳定性方程进行判断转捩点位置, 根据来流湍流度、几何、粗糙度等来进行判别），然后进行混合求解。

URANS的网格如果加密到一定长度，会呈现网格无关性(过滤掉了), 而在DES计算中，如果继续加密，则会越来越好，出现DNS的类似结果。


歼击机投下导弹的过程会在投递仓出现nose-up pitching moment 的现象，也就是导弹不按照
既定规定运行，可在方腔前头增加一个锥状挡板(来消去由于方腔引起的中间区域高压力梯度
的影响)。

激光在遇到密度有变化的流体时候，投射的光线会因此出现偏移


从三个方面，检查CFD计算。首先是数值方法(湍流模型，转捩区是否存在，一般SA算内流很不准
 局部非定常分离是否明显, 网格，y+等, 黏性因素),然后是物理模型(对大尺度影响较大，
对总体性能影响较大) ,最后是边界条件？(我觉得不应该这样考虑，因为数值方法中已经包含着
边界条件、湍流模型、网格、y+等条件。所以最后归结为从两个大的方面进行考虑
...
DES=Detached Eddy simulation(Incorporating local (u)Rans to model wall
boundary layer in an LES of wall-bounded flows------好处: relax grid
resolution(缺点是：各向同性 Cu=0.65有时候对各向异性的计算需要进行改变)

Embeded-LES :好处是enhance physical resolution(捕捉物理的分离流动)

Hybrid RANS-LES

RANS的参数标定通常是从边界层流动和槽道流中提取，但针对复杂的分离流动，这些
标定参数可能就需要修改（一般是一定需要修改)
RANS models(averaged turbulence) 谱实际物理的谱能进行smooth

湍流的长度尺度越小，对应的时间尺度越小（更符合湍流本身的模型）--
     从这个角度去理解实际的物理现象（越细你花的时间越长，你需要投入
     的经历越多)

LES的Tij代表能量的传输， 而URANS的Tij代表动量传输


学术常用的交互英文叫做Interaction

实际当中的仿真物理假设很多，不同的湍流模型就是如此，大多数情况下是一种湍流模型
用在一种实际的计算当中。

SAS(Scale-adaptive simulation) By Mentor

K-E转变为K-W（baseline SST)


如果雷诺数不一样，想要加入背景湍流，可以进行rescale

Gray-area灰区（一般是在hybrid RANS-LES的计算中存在), 透明区域、过渡区域

存在的问题： 解决underlying physics for RANS-LES interaction
            Transition located in the near-wake wall
            
扩散率的定义中是存在速度梯度的，所以他比k难算一些（实验、CFD就好像左右手，
实验的时间，是否能和计算的时间相一致，而不是说我去比较哪一个时刻对的比较好就
可以，如果对应流动存在period，的确可以这样做，但是对于玩去unsteady的流动？
是不是得让实验和CFD的起点时间进行一致、耦合？！

Unsteady physics---Time resolution ----Space resolution
** 聪明和时间的关系 [#B]                                            :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-21 周五 21:56]--[2018-12-21 周五 21:56] =>  0:00
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-21 周五 21:56]
                    :END:
                         
                    
Kang:"
    既然编辑已经作出了决定，就不可能让你再修改了，除非很大很大的面子了。
    (我想说，在未公开之前什么都可以更改)

    错误和挫折教训了我们，让我们逐渐变得聪明起来。(的确是得面对些错误和挫折了)
    "


但是有时候得去追逐自己想要的things。放手一搏和坚守是两个不同的态度，时间不允许，
不妨放手一搏。

总得经历几次波谷，才能起来!
** 演讲稿 [#B]                                                      :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-25 周二 10:30]--[2018-12-25 周二 12:58] =>  2:28
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-25 周二 10:30]
                    :END:
                         
                    
晓之以情，动之以理(礼)

先说， 某某，这是Mr Doctor的博士生，Mr Doctor也说该内容挺不错的，希望能发表出来
然后给他以礼物，让他看一下，放在一个角落

动之以理达到了第一步，然后说明特殊情况，自身博士四年级，家里要结婚等。

>> 要提高自己控制裕度，别让自己陷入太大的被动，改掉自身的三心二意, 事情得提早干!

首先，背景介绍，风力机运行过程中存在旋转、偏航、变桨等多自由度运动问题，而针对海上风力机还存在平台旋转和平动两部分构成的6自由度，这些运动都可以归结为多轴角运动问题(提出问题?感觉没有)

一定要突出你的目的(目的先行，重点先行) 要明确你的特点(非定常、结构网格、动态过程)
每页PPT都有它的目的，我们为了验证当前的计算方法(这页PPT干了什么事，重要吗？得到
什么结果,该问题可以当作askVisitorI,不断在你的PPT中apply，eval的目的是遍历所有
子结构，子内容，子对象，子文件，子环境，子方案，子方法，子类型)。

在去年的工程热物理会议上(要保证结构的连续性，研究的连续性，特别是跟人家介绍也是一样)
主要讲述了特定偏航角下的风轮非定常气动特性研究。在此基础上，本报告分别从三个方面进行
汇报，包括动态偏航、平台变桨、平台旋转(会议内容，可能只突出一个点，所以得重点分析某一过程，比如动态偏航过程中的气动特性变化规律),讲述多轴角运动的变化过程，在分析本报告
计算方法合理性的前提下，分析在多轴运动下存在的物理问题
** 可再生能源校稿 [#B]                                              :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-26 周三 10:47]--[2018-12-26 周三 10:47] =>  0:00
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-26 周三 10:47]
                    :END:
                         
                    
该论文针对偏航过程中风轮的动态尾流特性， 运用计算流体力学基本方法对NREL PhaseVI风力机进行了30°偏航角范围动态偏航过程数值模拟，得出动态与给定偏航速度云图，模拟方法正确，题名贴切，在应用上有所发展，但请根据意见作出修改，建议修改后录用。
具体修改意见：
1、	摘要：摘要应该满足基本的“研究目的、方法、结果、结论”四要素；请将第一句话“来流….稳定运行。”删除。建议修改为：针对偏航过程中风轮的动态尾流特性，运用计算流体力学（CFD）的基本方法对NREL PhaseVI风力机进行了30°偏航角范围动态偏航过程的模拟。“计算功率值和实验值吻合较好，验证了当前模拟的合理性。”删除。建议修改为模拟具体的结果，如，动态偏航速度云图分析和湍动能云图分析一些综合性的描述。请在最后增加结论，即带来的实际意义。
2、	引言的第一段，“通过改变风力机运行姿态“，建议修改为：“通过改变风力机运行方向”；“控制机组的风能利用效率”，建议修改为：“提高机组的风能利用效率”。最后一段，“但未对偏航过程中的总体性能以及尾迹结构的变化过程的研究较少。” 建议修改为：“但对于偏航过程中的总体性能以及尾迹结构的变化过程的研究较少”。请增加该研究带来的实际意义或者价值。
3、1.2“计算方法”，修改为，“数值方法”，与，1．“几何模型与数值方法”，相对应。收敛准则中“图7给出了收敛状态下的下游6D区域的速度水平截面云图”，请简单描述该云图的特征，以便为下文的动态偏航速度云图作为基准。
4、2结果与分析，第一段，请在 “本文对典型风速下(7m/s)…流动状况进行对比”，增加该方法的创新性或者应用价值。2.1 “CFD的计算结果和带Beddoes失速模型的结果与实验值基本吻合”，请用具体数值表示，偏差是多少？在“图8 b)”该段中，请认真重新组织该段的语言，有些语句含糊不清，过于繁琐，请精简。如，“该速度方向在风轮偏航轴的两侧分别和风轮旋转速度方向相同或相反，使得相对速度变大或变小，对应的攻角会变小或变大。”建议修改为“该速度在风轮偏航轴的两侧的方向和风轮旋转速度方向有一定的联系，使得相对速度进行变化，对应的攻角随之变化。”理由：论文语言应该严谨准确，建议不要用“相同或相反，变小或变大”。同理，“使得实际风轮相对速度增加或减小”，相应进行修改。“风轮的姿态变化额外产生的相对速度，”建议修改为“风轮的方向变化额外产生的相对速度，” 请认真核对该段的语句，并且重新组织。请在该段最后增加“2.1风轮载荷总体性能分布”与“2.2动态偏航速度云图分析”的联系。
6、2.2.2“可以发现随着风轮的动态偏转，中心涡附近的湍动能高能区域更为细长，并有着向下游方向发展的趋势，”请用横坐标具体数值说明。“在动态偏航过程中，尾迹速度的偏斜具有明显的迟滞。”通过尾流的变化，说明一个什么问题，有何新的发现或者与前人研究结果的不同?2.3.1标题请用一句话表示，最好中间不要用逗号隔开。2.3.2中，请适当用定量数值表示，该段只是定性表示，如“涡高湍动能区域均减小，湍动能强度逐渐衰减，随着偏航角增大，叶尖涡的涡量幅值减小，尾迹更为细长”等等。另外，“随着偏航角的增加高能湍动能区域逐渐减小并且集中在近尾流的叶根位置附近”，建议修改为“随着偏航角的增加导致高能湍动能区域逐渐减小，并且集中在近尾流的叶根位置附近。“请精简2.3.2该段语句。请在2.3.2最后增加通过湍动能云图的分析，对于风轮带来的实际意义。
7、结论，请增加3），在1）、2）对于风力机风轮在特定偏航角下和偏航过程的总体性能和尾流流动变化分析的基础上，对于风力机运行有何指导意义？与前人研究的异同？进一步研究该课题的意义？
** Apache commons库 [#B]                                              :java:
:LOGBOOK:
CLOCK: [2018-12-26 周三 11:44]--[2018-12-26 周三 11:46] =>  0:02
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-26 周三 11:43]
                    :END:
...
代码牧场
https://github.com/cforth/codefarm

学习是一种生活方式！（也可以的)
http://lixiaolai.com/
** submodule的好处 [#B]                                                :elisp:
:LOGBOOK:
CLOCK: [2018-12-28 周五 00:32]--[2018-12-28 周五 00:34] =>  0:02
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-28 周五 00:32]
                    :END:
...
** 没有交流的交流 [#B]                                              :@NCEPU:
:LOGBOOK:
CLOCK: [2018-12-28 周五 21:17]--[2018-12-28 周五 22:27] =>  1:10
:END:

                    :PROPERTIES:
                    :CREATED: [2018-12-28 周五 21:17]
                    :END:
                         
                    
我选择了？ 没能力去选择那么多想要的东西，没有决心去做你想去做的事情，
没有资源，没有话语权，最重要是没有思想，被迫的去做自己不喜欢的事情，
人人都走的这条路是挺累的，这也是沉默的大多数，大家都不能逃避的现实。

一条路走累了，真感觉走不下去，惰性很强，一碰到问题就不想着解决。
(这贼比老头真累)

我的人生我做主，我的生命我做主，我的时间我做主。中国上下五千年，
真正做主的人并不多。农民、工人翻身做主人，真的做了？ 还是得有一把伞。

虽然做不了主人，但是起码你得能去有学习的能力去往独立自主的路线方向
发展。独立自主的一个人，才能做你想做的事情。

一个人要有内心值得骄傲，值得专研的底料，即使这玩意他们很不屑。一杯酒
经历过很久才能释放出酒香，享受时间的精雕细琢，是作为一个匠人、艺术家
大家所必须经历的。所以酒本身就是一个大家，得经常陪伴。你得去看那段让你
埋头苦干的日子，那叫做睁开你那闪烁的双眼看透世间的魑魅魍魉和不干不净。
时间给与了自我，雕琢了自身，所以很多人信的是时间，Timist!酒本身是由
时间和粮食锻造，所以我认为酒也是一种时间。

Girl said to me，不需要跪舔的爱情，我的确是在跪舔，羔羊一样！本性
却是狮子. 对别人的关心，有时候只是一种跪舔。 付出时间的努力和思考，
都可以认为是你对你的人生的一种负责。(从时间的维度，去思考问题)

如果人长期处于孤独和紧张状态，就很容易生病，而适量饮酒能使人精神愉快。酒的陶醉作用能够缓和人的忧虑和紧张心理，增强安定感，提高生活的兴趣，对老年人尤其如此。针对不少老年人易发怒、易不满、孤独不快以及其他令人难以理解的古怪性情，日本的一些养老院有时用一两杯酒代替通常服用的镇静药物，成功地改善了养老院的气氛，使之洋溢出和睦家庭中才有的气氛


酒是一种味，而且最好是静味, 静静地体味他的香味
** 关注一下快科技 [#B]                                              :@NCEPU:
:LOGBOOK:
CLOCK: [2019-01-04 周五 22:23]--[2019-01-04 周五 22:23] =>  0:00
:END:

                    :PROPERTIES:
                    :CREATED: [2019-01-04 周五 22:23]
                    :END:
                         
                    
http://news.mydrivers.com/1/610/610021.htm
** 职责所在 [#B]                                                    :@NCEPU:
:LOGBOOK:
CLOCK: [2019-01-05 周六 18:37]--[2019-01-05 周六 18:49] =>  0:12
:END:

                    :PROPERTIES:
                    :CREATED: [2019-01-05 周六 18:37]
                    :END:
                         
                    
<2019-01-05 18:37>醉卧沙场君莫笑，古来征战几人回

职责不是偷懒懈怠、无所事事。

而是带着目标

这个社会有用的人太多，有趣的人太少，王小波是一个特别有趣的人
...
灵魂分为优美和丑陋
https://www.kanunu8.com/files/writer/156.html
** 思维结构很重要 [#B]                                              :@NCEPU:
:LOGBOOK:
CLOCK: [2019-01-05 周六 19:17]--[2019-01-05 周六 21:00] =>  1:43
:END:

                    :PROPERTIES:
                    :CREATED: [2019-01-05 周六 19:17]
                    :END:
                         
                    
你有很多想法，但是却不能有序、有结构的表达出来

https://www.zhihu.com/question/19727047/answer/522905472

又得聊聊结构化思维（结构化表达出来)

按照一定时间顺序、分先后，按照重要级别。（在什么阶段思考什么问题，
做了什么事情，并且事情具有重要性，得到了什么结果)

结构金字塔!

正如军纪一样，人们思考问题也得有一定的纪律性，就好像写文章也得有章法一样
(思维结构其实就是章法) 先学差点章法，再学高级点的。

长期的思维训练，才会形成思维习惯，得到一定的思维结构。

SCQA(situation conflict(但是其实有时候问题、要做的事情、挑战的事情)
 Question Answer是一个不错的思维训练风格
 
*** 年终总结
 #+BEGIN_SRC org
   应用场景一：年终总结，其实主要就是两件事：第一你上一年做了什么，第二下一年的计划是怎样的。
...
请求领导、部门支持的邮件
    ...
    这时候读者的疑问是：Q——我们是否要批准这个方案？

    A——你必须尽快批准这个方案。理由是A。。。B。。。C…
...
#+BEGIN_SRC org
  S： 我们知道风力机缩比实验需要经过相似性的准则判定，得到的结果才具有一定的意义，于是我们选取其中最重要的尖速比相似准则，获得一定尖速比下，不同风速下缩比风力机需要达到的转速。

  C：然而在吹风过程中，我们发现并不能让一定的风速下，吹到理论计算需要的转速。 

  Q: 到底是什么导致转速上不去？ 

  A: 我们首先检查了轮毂侧的问题， 阻尼过大？ 同轴？（两个轴承，磁粉制动器还有一个线圈绕组）
...
#+BEGIN_SRC org
  乔布斯曾经在发布会上介绍iPhone手机时，运用的就是这个模型。

他先是说市场上有很多其他品牌的手机（场景Situation），
但是它们对你来说都不好用（冲突Complication），
不好用在哪？（问题Question）？
iPhone告诉你！（回答Answer）
#+END_SRC
...
#+BEGIN_SRC org
  ...
  在微信公众号上我们点赞、转发、保存、收藏（场景Situation），
  好像懂了很多东西，但真正记住知识的寥寥无几（冲突Complication）。
  如何解决这个问题呢（问题Question）？
  先从以下7步开始吧！（回答Answer）。
#+END_SRC
...
#+BEGIN_SRC org
  集团近年来发展速度快、产量逐年提高，众
  多项目被列为北京市重点项目，然而在如此高速
  发展的背景下，集团资金缺口成为限制集团快速
  发展的主要瓶颈，如何拓展融资渠道、降低融资
  成本、提高资金使用效率？特设计全方位的创新
  金融服务支持方案。
#+END_SRC

[[file:AnZaiTian.org][安在天给阿炳讲故事]]

我们每一天需要在我们的evaluation添加一些interesting的模式, 新建的事
新鲜的话题有时候在你的evaluation或者interpretion是一个新的pattern。
...
apply程序包含着所有的解释，观点解释。
** 一切未定之前 [#B]                                              :@Company:
:LOGBOOK:
CLOCK: [2019-01-06 周日 18:23]--[2019-01-06 周日 18:31] =>  0:08
:END:

                    :PROPERTIES:
                    :CREATED: [2019-01-06 周日 18:23]
                    :END:
                         

                    
一切事情没有尘埃落定，提前兴奋容易落得一场空!
** 自律 [#B]                                                        :@NCEPU:
:LOGBOOK:
CLOCK: [2019-01-06 周日 21:08]--[2019-01-06 周日 21:27] =>  0:19
:END:

                    :PROPERTIES:
                    :CREATED: [2019-01-06 周日 21:08]
                    :END:
                         
                    
https://fishc.com.cn/blog-249302-2217.html
第一篇 如何提高意志力 
...
控制自己的思想 
“意志力与思想控制有直接的联系。一旦你意识到你能够让积极的思想排挤掉消极的思想，你就朝着自律一生前进了一大步。”–吉姆·兰德尔 
...
　　每天坚持学习的最好方法就是把学习变成一种习惯。我以前在书上看到过一个行为科学研究的结论：一个人一天的行为中大约只有５%是属于非习惯性的，而剩下的９５%的行为都是习惯性的。当花上一段时间把你的学习计划变成自己的习惯之后，你就会发现自己离目标越来越近。 

　　你可能听到过２１天左右能形成一个新的习惯的说法，但这只是一个大概的情况。但这个周期根据不同的人和习惯而变化，周期从几天到几个月不等。不管这个周期要多长时间，一般都要经历过三个阶段： 
...
１、每天的时间要适度，找到适合自己强度的时间。你需要根据自己的实际情况来调整每天的学习计划。你以前从来没有学习连续学习一个小时以上，就不要制订一个每天学习２或３个小时的学习计划。你可以把它变为每天学习半小时或一个小时。再把半小时或一个小时的学习时间拆分为每次１０分钟或２０分钟，更容易每天坚持下去。 

２、把每天的学习计划放在首要位置。你可以每天早上提前起来１０分钟或半小时，用来完成学习计划。尽量把每天的学习计划放在第一件要做的事情。你可以充分利用早上的时间来完成你的学习计划。 

３、充分利用零散时间来完成你的计划。有的时候你会发现自己很忙，无法拿出整声的时间来学习。这时你可以学习利用零散的时间段来完成你的计划。如上下班做车的时间，午饭时间，排队的时间等一些小块的时间。 
** ABORT listary：文件和app启动器 [#B]                              :@NCEPU:
CLOSED: [2019-01-10 周四 16:28]
:LOGBOOK:
CLOCK: [2019-01-10 周四 16:19]--[2019-01-10 周四 16:19] =>  0:00
:END:

                    :PROPERTIES:
                    :CREATED: [2019-01-10 周四 16:19]
                    :END:
                         
                    
感觉类似于TotalCommand 和everything,感觉没用删掉
** 读书这个行为意味着你没有完全认同这个世界 [#B]                    :@NCEPU:
:LOGBOOK:
CLOCK: [2019-01-12 周六 22:18]--[2019-01-12 周六 22:20] =>  0:02
:END:

                    :PROPERTIES:
                    :CREATED: [2019-01-12 周六 22:17]
                    :END:
                         
                    
https://www.sohu.com/a/207620132_718263
