...
** TODO 技术词和生活用词收集
:LOGBOOK:
- State "TODO"       from              T:[2018-12-27 周四 21:32]
:END:

*** 写作原则

1. 结构上，金字塔，结论而行，论据随后，总结陈述
2. 语言上，简练(一个动词可解决，不要用多)，清楚，易读(clarify)，准确(concise)
       一句话干了什么事？有用？如果有用，那么接下来讲什么?然后讲什么? 
3. 风格上，主谓结构，简单句
   
***  单词和词组
|   | professional words | everyday words             | Notes |
|---+--------------------+----------------------------+-------|
|   |                <r> | <l>                        |       |
|   |             absorb | take in                    |       |
|   |           discover | find out                   |       |
...
|   |        significant | big                        |       |
|   |             method | way(of doing)              |       |
|   |       synthesising | bring together             |       |
|   |             object | thing                      |       |
|   |    little research | not much research          |       |
|   |        few studies | not many studies           |       |
|   |       not evidence | isn't any evidence         |       |
...
|              functionally | 从功能上讲     |
|                physically | 从物理概念上   |
|            mathematically | 从数学上讲     |
|             theoretically | 从理论上讲     |
|            experimentally | 从实验上讲     |
|        characteristically | 从特性上讲     |
|               graphically | 从图形上讲     |
|           chronologically | 从年代上看     |
|             alternatively | 换言之         |
|              analytically | 用解析的方法   |
|                 certainly | 直观地讲       |
|            conventionally | 按照惯例       |
...
|              incidentally | 顺便指出       |
|              equivalently | 等效地讲       |
|           correspondingly | 与之对应的是   |
|                   ideally | 理想情况下     |
|               inductively | 归纳起来       |
|           architecturally | 从结构上看     |
|                 logically | 从逻辑上讲     |
|                personally | 就个人而言     |
|            simultaneously | 与此同时       |
|                presumably | 可能的情况是   |
|                ultimately | 归根结底       |
|              symbolically | 用符号表示的话 |
|                    rarely | 很少           |
|                   usually | 通常           |
|                  visually | 从视觉效果上看 |
|                   finally | 最后           |
...
|     more/most importantly | 更/最重要的是  |
|            more generally | 更一般的情况   |
| more precisely/accurately | 更确切地说     |
|      more briefly	 | 更简练地讲     |
|                           |                |
...
|                       <r> | <l>            |
|---------------------------+----------------|
|         to a small extent | 在不大程度上   |
|            to what extent | 在多大程度上   |
|       to different extent | 在不同程度上   |
|            to some extent | 在某种程度上   |
|           to great extent | 在很大程度上   |
| to the extent practicable | 在可实用程度上 |
...
|           be essential to | 对…是至关重要 |
| by far the most important | 最重要的      |
|              come to play | 开始起作用    |
|         play a major role | 起主要作用    |
|      play a dominant role | 起主导作用    |
| deserve a special mention | 值得专门提到  |
...
|                        <r> | <l>             |
|----------------------------+-----------------|
| … somewhat easier … than … | 多少比…容易一些 |
|            … even easier … | 更容易一些      |
|          … be readily to … | 容易地          |
|      … relatively simple … | 相对简单        |
|            … far simpler … | 简单得多        |
|   … rather sophisticated … | 相当微妙的      |
|          be self-evident … | 不言自明的      |
...
|                            <r> | <l>            |
|--------------------------------+----------------|
|                   no more than | 不多于，仅仅占 |
|                     a few more | 比…更多一点    |
|            in part / partially | 部分的         |
|                     throughout | 整个           |
| be not sufficient to determine | 不足以确定…    |
|                   more or less | 或多或少       |
...
|--------------------------------+--------------|
|                     well-known | 众所周知     |
|        celebrated / best known | 著名的       |
|               most outstanding | 最突出的     |
|         remarkable achievement | 显赫的成就   |
| most significant contributions | 最重要的贡献 |
|                   epoch-making | 划时代的     |
...
* TODO [#A] 基于多轴角运动的气动特性和流场分析大论文 <2018-06-25 周一 16:19>[7/10] :学术:
DEADLINE: <2019-04-15 周一>
                    ...
                    :LOGBOOK:
                    - State "TODO"       from "TODO"          T:[2019-01-14 周一 12:37]
                    - State "TODO"       from "TODO"          T:[2019-01-14 周一 12:36]
                    - State "TODO"       from "TODO"       T:[2018-12-18 周二 08:38]
                    - State "TODO"       from "TODO"       T:[2018-12-18 周二 08:38]
                    - State "TODO"       from "TODO"          T:[2018-12-11 周二 14:43]
                    - State "TODO"       from "TODO"          T:[2018-12-11 周二 14:43]
...
验证完湍流模型之后，为了表示非定常时间步选择的合理性，再考虑使用不同时间步
4. [X] 负偏航角计算(-30°)
...
*** TODO [#A] NREL 5MW fluent静态和动态偏航计算 <2018-06-25 周一 08:42>[4/5] :学术:
...
**** ABORT [#A]  NREL5MW动态数据处理+文章写作 <2018-08-23 周四 18:52> :@NCEPU:
CLOSED: [2019-01-14 周一 12:37] DEADLINE: <2018-12-14 周五> SCHEDULED: <2018-08-23 周四>
                    :PROPERTIES:
                    :Effort: 4:00
                    :END:
                    :LOGBOOK:
...
*** ABORT [#B] 修正nrel5MW处理cn ct代码 <2018-08-29 周三 10:33>    :@NCEPU:
CLOSED: [2019-01-14 周一 12:36] SCHEDULED: <2018-08-29 周三>
                    :PROPERTIES:
                    :Effort: 4:00
                    :CATEGORY: Coding
                    :END:
...
*** DONE [#B] YawingForRenewableEnergyChina <2018-11-29 周四 17:07> [6/6] :PROJECT:
CLOSED: [2018-12-11 周二 14:43] DEADLINE: <2018-12-06 周四> SCHEDULED: <2018-11-29 周四>
                    :Effort: 16:00
                    :PROPERTIES:
                    :CATEGORY: Project-Yawing
                    :END:
                    :LOGBOOK:
                    CLOCK: [2018-12-05 周三 09:53]--[2018-12-05 周三 10:57] =>  1:04
                    - Clocked out on T:[2018-12-05 周三 10:57]
                    CLOCK: [2018-12-04 周二 22:15]--[2018-12-04 周二 23:01] =>  0:46
                    - Clocked out on T:[2018-12-04 周二 23:01]
                    CLOCK: [2018-12-04 周二 15:49]--[2018-12-04 周二 19:49] =>  4:00
                    - Clocked out on T:[2018-12-04 周二 19:49]
...
*** DOING [#B] Yawing NREL 5MW for Energy <2018-11-29 周四 17:10> [0/6] :@NCEPU:PROJECT:紧急重要:
DEADLINE: <2018-12-22 周六> SCHEDULED: <2018-11-29 周四>
                    :PROPERTIES:
                    :Effort: 22:00
                    :CATEGORY: Project-Yawing5MW
                    :END:
                    :LOGBOOK:
                    CLOCK: [2018-12-28 周五 22:27]--[2018-12-29 周六 01:57] =>  3:30
                    - Clocked out on T:[2018-12-29 周六 01:57]
                    CLOCK: [2018-12-28 周五 20:33]--[2018-12-28 周五 21:17] =>  0:44
                    - Clocked out on T:[2018-12-28 周五 21:17]
                    CLOCK: [2018-12-28 周五 14:11]--[2018-12-28 周五 16:19] =>  2:08
                    - Clocked out on T:[2018-12-28 周五 16:19]
                    CLOCK: [2018-12-26 周三 14:47]--[2018-12-26 周三 19:39] =>  4:52
                    - Clocked out on T:[2018-12-26 周三 19:39]
                    - New deadline from "[2018-12-29 周六]" on T:[2018-12-18 周二 08:39] \\
                      抓紧
...
5. [ ] Conclusion
6. [ ] References
*** TODO [#B] Platform motion with Pitching and Rolling of NREL 5MW for energy <2018-11-29 周四 17:11>[0/6] :@NCEPU:PROJECT:
