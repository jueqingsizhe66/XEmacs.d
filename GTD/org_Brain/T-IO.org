...
•	哦，说这么，其实就是想挑战J2cache，不过tio-utils也把J2cache门面化了^_^
*** tio-core
...
2018年
•	基于tio-core、tio-websocket、tio-http、tio-webpack的大型金融直播平台—— 牛吧云播正式上线
•	GVP开源项目贝密游戏在已经大量使用netty的情况下，用t-io重写通讯模块，并表示：” 换上t-io后，吃嘛嘛香 “
•	开源java区块链平台md_blockchain表示：” t-io在联盟链的网络通信中表现非常稳定 “
•	基于t-io的开源IM项目 J-IM ，获得开源社区的极大关注，并斩获GVP大奖，据说J-IM作者薪水大涨^_^
•	氦氪云 的协议网关采用t-io实现
•	上市公司 长飞光纤 ，S8000协议采用t-io实现
•	更多的用户愿意反馈t-io使用案例
2017年
•	talent-aio改名为t-io
•	用t-io实现了http、websocket协议
•	基于tio-http创建了用于传统前端的tio-webpack框架
•	t-io案例大量产生，用户口碑极佳
•	获GVP(Gitee Most Valuable Projects) - 码云最有价值开源项目计划、年度欢迎开源项目等奖
2016年
•	用AIO技术创建了talent-aio框架，代码入驻码云
2015年
•	开始关注AIO技术，同时进一步提升和封装多线程、锁等技术
2014年
•	用talent-nio实现了热波直播平台的IM模块
2013年
•	短暂性介入开源项目mycat，并用talent-nio实现了Mycat-Balance(不是pom方式引入)
2012年
•	在离开中兴后，用开发EMF积累的NIO及多线程等知识，创建了talent-nio框架
2011年
•	新EMF框架应用于新的网管项目V4，该项目迄今(2018-12-27)仍然稳定运行
2010年
•	用NIO技术重写中兴网管底层通讯框架EMF，解决了大量不稳定因素
...
•	当通信的对方把数条数据包放在一个TCP包中发过来时，粘包就产生了，而程序没有考虑到一次TCP收包会收到多个业务包，从而解析到第一个业务包后把后面的业务包丢弃了
