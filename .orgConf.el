...
(defun my/quantified-get-hours (category time-summary) 
  ...
  (if (stringp category) 
      (if (assoc category time-summary) 
          (/ (cdr (assoc category time-summary)) 3600.0) 0) 
    (apply '+ (mapcar (lambda (x) 
                        (my/quantified-get-hours x time-summary)) category))))
  ...
  (with-temp-buffer (insert string) 
                    ...
                    (while (re-search-forward line-re nil t) 
                      (let ((temp-list matchers)) 
                        (while temp-list (if (save-match-data (string-match (car (car temp-list)) 
                                                                            (match-string 1))) 
                                             (progn (add-to-list (cdr (car temp-list)) 
                                                                 (concat prefix (match-string 3)) t) 
                                                    (setq temp-list nil))) 
...
(ert-deftest 
  ...
  (let (list-a list-b (line-re "\\([^:]+\\):\\( \\)\\(.*\\)")) 
    (_my/extract-tasks-from-agenda "listA: Task 1\nother: Task 2\nlistA: Task 3" '(("listA" .
                                                                                    list-a) 
                                                                                   ("." . list-b))
                                   "- [ ] " line-re) 
...
(defun _my/get-upcoming-tasks () 
  (save-window-excursion (org-agenda nil "W") 
...
(defun _my/get-previous-tasks () 
  (let (string) 
    (save-window-excursion (org-agenda nil "W") 
                           ...
                           (_my/extract-tasks-from-agenda string '(("routines" . ignore) 
                                                                   ("business" . business) 
...
(defun my/org-summarize-focus-areas (date) 
  ...
  (interactive (list (org-read-date-analyze (if current-prefix-arg (org-read-date) "-fri") nil '(0 0
                                                                                                   0)))) 
  (let (business relationships life business-next relationships-next life-next string Emacs
                 emacs-next start end time-summary biz-time ignore base-date) 
    (setq base-date (apply 'encode-time date)) 
    (setq start (format-time-string "%Y-%m-%d" (days-to-time (- (time-to-number-of-days base-date)
                                                                6)))) 
    (setq end (format-time-string "%Y-%m-%d" (days-to-time (1+ (time-to-number-of-days
                                                                base-date))))) 
    (setq time-summary (quantified-summarize-time start end)) 
    (setq biz-time (my/quantified-get-hours "Business" time-summary)) 
    (_my/get-upcoming-tasks) 
    (_my/get-previous-tasks) 
    (setq string (concat (format "- *Business* (%.1fh - %d%%)\n" biz-time (/ biz-time 1.68)) 
                         (mapconcat 'identity business "\n") "\n" (mapconcat 'identity business-next
                                                                             "\n") "\n" (format
                                                                                         "  - *Earn* (%.1fh - %d%% of Business)\n"
                                                                                         (my/quantified-get-hours
                                                                                          "Business - Earn"
                                                                                          time-summary) 
                                                                                         (/
                                                                                          (my/quantified-get-hours
                                                                             ...
                                                                             (mapconcat 'identity
                                                                                        ...
                                                                                        (mapconcat
                                                                                         ...
                                                                                         "\n"
                                                                                         (format
                                                                                          "- *Discretionary - Productive* (%.1fh - %d%%)\n"
                                                                                          (my/quantified-get-hours
                                                                                         ...
                                                                                         (format
                                                                                          "  - *Drawing* (%.1fh)\n"
                                                                                          (my/quantified-get-hours
                                                                                           '("Discretionary - Productive - Drawing")
                                                                                           time-summary)) 
                                                                                         (format
                                                                                          "  - *Emacs* (%.1fh)\n"
                                                                                          (my/quantified-get-hours
                                                                                         ...
                                                                                         (mapconcat
                                                                                          ...
                                                                                          (format
                                                                                           "  - *Coding* (%.1fh)\n"
                                                                                           (my/quantified-get-hours
                                                                                            "Discretionary - Productive - Coding"
                                                                                            time-summary)) 
                                                                                          (mapconcat
                                                                                           'identity
                                                                                           life
                                                                                          ...
                                                                                          (format
                                                                                           "  - *Sewing* (%.1fh)\n"
                                                                                           (my/quantified-get-hours
                                                                                            "Discretionary - Productive - Sewing"
                                                                                            time-summary)) 
                                                                                          (format
                                                                                           "  - *Writing* (%.1fh)\n"
                                                                                           (my/quantified-get-hours
                                                                                            "Discretionary - Productive - Writing"
                                                                                            time-summary)) 
                                                                                          (format
                                                                                           "- *Discretionary - Play* (%.1fh - %d%%)\n"
                                                                                           (my/quantified-get-hours
                                                                                            "Discretionary - Play"
                                                                                            time-summary) 
                                                                                           (/
                                                                                          ...
                                                                                          (format
                                                                                           ...
                                                                                           (/
                                                                                            ...
                                                                                            1.68)) 
                                                                                          (format
                                                                                           "- *Sleep* (%.1fh - %d%% - average of %.1f per day)\n"
                                                                                           (my/quantified-get-hours
                                                                                            "Sleep"
                                                                                            time-summary) 
                                                                                           (/
...
(let* ((variable-tuple (cond ((x-list-fonts "Source Sans Pro") 
                              '(:font "Source Sans Pro")) ;; ;; ;;
  ...
  (custom-theme-set-faces 'user
                          ...
                          `(org-level-1 ((t (,@headline ,@variable-tuple 
                                                        :height 1.75)))) ;; ;; ;;
                          `(org-document-title ((t (,@headline2 ,@variable-tuple 
                                                                :height 1.5 
                                                                :underline nil)))))) ;; ;; ;;
...
(defun journal-file-insert () 
  ...
  (let* ((year  (string-to-number (substring (buffer-name) 0 4))) 
    ...
    (when (equal (file-name-base (buffer-file-name)) 
      ...
      (let ((weekday-template (downcase (format-time-string "journal-%a.org")))) 
      ...
      (let ((contents (buffer-string))) 
        (delete-region (point-min) 
                       (point-max)) 
        (yas-expand-snippet contents (point-min) 
                            (point-max))))))
...
(defun get-journal-file-yesterday () 
  ...
  (let* ((yesterday (time-subtract (current-time) 
                                   (days-to-time 1))) 
...
of the week)."
  (let* ((last-year-seconds (- (float-time) 
                               (* 365 24 60 60))) 
...
(when 
  ...
  (define-key org-tree-slide-mode-map (kbd "S-<f9>") 'org-tree-slide-content) 
  (setq org-tree-slide-skip-outline-level 4) 
...
(setq org-dashboard-files (list "~/.emacs.d/GTD/orgBoss/newgtd.org"
                                "~/.emacs.d/GTD/orgBoss/hello.org" "~/.emacs.d/GTD/phd1.org"))
...
(defun my/org-dashboard-filter (entry) ;;
  (and (>= (plist-get entry 
       ...
       (not (member "archive" (plist-get entry 
                                         :tags)))))  ;;
;;
...
(use-package 
  ...
  :init (setq org-mru-clock-how-many 100 org-mru-clock-completing-read #'ivy-completing-read))
...
(use-package 
  org-brain 
  :ensure t 
  :init (setq org-brain-path "~/.emacs.d/gtd/org_Brain")
  ;; For Evil users
  (with-eval-after-load 'evil (evil-set-initial-state 'org-brain-visualize-mode 'emacs)) 
  :config (setq org-brain-file-entries-use-title nil) 
...
(with-eval-after-load 'org-agenda (bind-key "i" 'org-agenda-clock-in org-agenda-mode-map))
...
;; see org-ref for use of these variables
(setq org-ref-bibliography-notes "~/.emacs.d/GTD/orgref/notes.org" org-ref-default-bibliography '("~/.emacs.d/GTD/orgref/reference.bib"
                                                                                                  "~/.emacs.d/GTD/orgref/20180324.bib"
                                                                                                  "~/.emacs.d/GTD/orgref/20180303.bib"
                                                                                                  "~/.emacs.d/GTD/orgref/higherMegawatt.bib"
                                                                                                  "~/.emacs.d/GTD/orgref/20161223.bib")
...
(use-package 
  ...
  :defer t 
  :config (progn 
            (setq artbollocks-weasel-words-regex (concat "\\b" (regexp-opt '("one of the" "should"
                                                                             "just" "sort of"
                                                                             "a lot" "probably"
                                                                             "maybe" "perhaps"
                                                                             "I think" "really"
...
With a prefix ARG always prompt for command to use." 
  (interactive "P") 
  (when buffer-file-name (shell-command (concat (cond ((and 
                                                        (not arg) 
...
(defun my/org-entry-wpm () 
  (interactive) 
  (save-restriction (save-excursion (org-narrow-to-subtree) 
                                    (goto-char (point-min)) 
                                    (let* ((words (count-words-region (point-min) 
                                                                      (point-max))) 
...
(defun +org/last-update-before (since) 
  ...
  (let ((next-headline (save-excursion (or (outline-next-heading) 
    ...
    (let* ((subtree-end (save-excursion (org-end-of-subtree t))) 
           (subtree-valid (save-excursion (forward-line 1) 
                                          (if (and (< (point) subtree-end)
                                            ...
                                            (point-max))))) 
      (if (and subtree-valid 
               (>= subtree-valid since)) next-headline nil))))
